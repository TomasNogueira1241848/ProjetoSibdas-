                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="card text-center p-3 h-100">
                                <i class="fa-solid fa-hospital fa-2x mb-2" style="color: var(--cor-primaria);"></i>
                                <h3 class="fw-bold" style="color: var(--cor-primaria);">+50</h3>
                                <p class="text-muted mb-0 small">Instituições clientes</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card text-center p-3 h-100">
                        ...
                        <div class="col-6">
                            <div class="card text-center p-3 h-100">
                                <i class="fa-solid fa-users fa-2x mb-2" style="color: var(--cor-primaria);"></i>
                                <h3 class="fw-bold" style="color: var(--cor-primaria);">+30</h3>
                                <p class="text-muted mb-0 small">Profissionais</p>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card text-center p-3 h-100">
                                <i class="fa-solid fa-headset fa-2x mb-2" style="color: var(--cor-primaria);"></i>
                                <h3 class="fw-bold" style="color: var(--cor-primaria);">24/7</h3>
                                <p class="text-muted mb-0 small">Suporte técnico</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="card p-4 h-100">
                        <h5 class="fw-bold mb-4">
                            <i class="fa-solid fa-address-card me-2" style="color: var(--cor-primaria);"></i>
