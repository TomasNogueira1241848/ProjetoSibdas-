                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="aba-dados" role="tabpanel">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="fornecedorEquipamento" class="form-label">Fornecedor
                                        </label>
                                        <select class="form-select" id="fornecedorEquipamento" required>
                                            <option value="">Selecionar</option>
                                            <option value="Philips Healthcare Portugal" selected>Philips
                                                Healthcare Portugal</option>
                                    ...
                                    <div class="col-md-4">
                                        <label for="dataAquisicaoEquipamento" class="form-label">Data de
                                            aquisição</label>
                                        <input type="date" class="form-control" id="dataAquisicaoEquipamento"
                                            value="2023-06-10" required>
                            ...
                            <div class="tab-pane fade" id="aba-localizacao" role="tabpanel">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="localizacaoEquipamento" class="form-label">Localização
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="pisoEquipamento" min="-1" step="1"
                                            value="2" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="salaEquipamento" value="UCI-02"
                                            required>
                            ...
                            <div class="tab-pane fade" id="aba-documentacao" role="tabpanel">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <p class="text-muted small mb-0">
                                            Estes documentos já estão associados ao equipamento. Pode adicionar ou
                                            substituir PDFs se necessário.
                                        </p>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="pdf-upload-card h-100">
                                            ...
                                            <input type="file" class="form-control input-pdf-multiplo"
                                                ...
                                                multiple data-lista="listaManualServicoEquipamento">
                                    ...
                                    <div class="col-12 mt-3">
                                        ...
                                        <p class="text-muted small mb-0">
                                            Documentos adicionais associados ao equipamento.
                                        </p>
                                    </div>
                                        ...
                                        <div class="pdf-lista mb-3">
                                            <div class="pdf-item">
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger btn-remover-pdf-existente">
                                    ...
                                    <div class="col-12">
                                        <div class="pdf-upload-card">
                                            <label for="ficheirosOutrosDocumentosEquipamento"
                                                class="form-label fw-semibold">
                                                <i class="fa-solid fa-file-pdf me-1 text-danger"></i> Adicionar PDFs
                                                adicionais
                                            </label>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="codigoGarantiaEquipamento"
                                            value="GAR-001" required>
                                        <div class="invalid-feedback">Introduza o código da garantia.</div>
                                    </div>

                                    <div class="col-md-8">
                                        <label for="designacaoGarantiaEquipamento" class="form-label">Designação
                                            da garantia</label>
                                        <input type="text" class="form-control" id="designacaoGarantiaEquipamento"
                                            value="Garantia Monitor Multiparamétrico" required>
                                    ...
                                    <div class="col-md-6">
                                        <label for="inicioGarantiaEquipamento" class="form-label">Início da
                                            garantia</label>
                                        <input type="date" class="form-control" id="inicioGarantiaEquipamento"
                                            value="2023-06-10" required>
                                        <div class="invalid-feedback">Introduza a data de início da garantia.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="fimGarantiaEquipamento" class="form-label">Fim da
                                            garantia</label>
                                        <input type="date" class="form-control" id="fimGarantiaEquipamento"
                                            value="2026-06-10" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="contratoEquipamento" required>
                                            ...
                                            <option value="CON-001" selected>CON-001 — Contrato de Manutenção
                                                UCI</option>
                                        </select>
                                    ...
                                    <div class="col-12">
                                        <label for="coberturaGarantiaEquipamento" class="form-label">Cobertura
                                            de garantia</label>
                                        <textarea class="form-control" id="coberturaGarantiaEquipamento" rows="3"
                                            required>Cobertura de peças, mão de obra e assistência técnica durante o período de garantia.</textarea>
                                        <div class="invalid-feedback">Introduza o campo de cobertura de
                                            garantia.</div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="pdf-upload-card h-100">
                                            <label for="ficheirosGarantiaEquipamento" class="form-label fw-semibold">
                                                <i class="fa-solid fa-file-pdf me-1 text-danger"></i> Adicionar
                                                PDFs da garantia
                                            </label>
                                            ...
                                            <input type="file" class="form-control input-pdf-multiplo"
                                                ...
                                                accept="application/pdf,.pdf" multiple
                                                data-lista="listaFicheirosGarantiaEquipamento">
                                    ...
                                    <div class="col-md-6">
                                        <div class="pdf-upload-card h-100">
                                            ...
                                            <input type="file" class="form-control input-pdf-multiplo"
                                                ...
                                                accept="application/pdf,.pdf" multiple
                                                data-lista="listaFicheirosContratoEquipamento">
                                            <div class="invalid-feedback">Selecione um ficheiro.</div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="responsavelManutencaoEquipamento"
                                            value="Serviço de Engenharia Clínica" required>
                                        <div class="invalid-feedback">Introduza o resposável da manutenção.
                                        </div>
                                    </div>
