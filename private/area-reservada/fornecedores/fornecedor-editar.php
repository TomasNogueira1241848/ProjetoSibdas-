        ...
        <main class="col-12 col-md-9 col-lg-10 p-3 p-md-4 overflow-hidden" id="dashboard">
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                <div>
                    ...
                    <p class="text-muted small mb-0">Atualização dos dados do fornecedor selecionado.</p>
                </div>
            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" id="nomeFornecedor" name="nomeFornecedor"
                                    value="Philips Healthcare Portugal" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="nifFornecedor" name="nifFornecedor"
                                    value="501234567" maxlength="9" min="0" step="1" required>
                                <div class="invalid-feedback">Introduza o NIF do fornecedor.</div>
                            </div>

                            <div class="col-md-6">
                                <label for="tipoFornecedor" class="form-label">
                                    Tipo
                                </label>
                            ...
                            <div class="col-md-6">
                                <label for="emailFornecedor" class="form-label">
                                    Email
                                </label>
                                <input type="email" class="form-control" id="emailFornecedor" name="emailFornecedor"
                                    value="suporte@philips.pt" required>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="moradaFornecedor" name="moradaFornecedor"
                                    value="Av. da República, 90, 1050-190 Lisboa" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="observacoesFornecedor" name="observacoesFornecedor"
                                    rows="3" required>Fornecedor principal de equipamentos de monitorização.</textarea>
